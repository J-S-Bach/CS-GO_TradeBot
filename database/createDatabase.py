...
buy = '''CREATE TABLE IF NOT EXISTS buy
            (internal_id, buy_id INTEGER primary key, buy_id_3p,buyPrice, buyPlatform, buytime)'''
sell = '''CREATE TABLE IF NOT EXISTS sell
            (internal_id, sell_id INTEGER primary key, sellPrice, sellPlatform, selltime)'''
owned_items = '''CREATE TABLE IF NOT EXISTS owned_items
            (internal_id INTEGER primary key, itemPlace, asset_id_steam, asset_id_3p, def_index)'''
